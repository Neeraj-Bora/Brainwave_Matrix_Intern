...
export default function Footer() {
  return (
    <div className="px-60 py-10 text-gray-500 text-sm bg-gray-50">
      <footer>
        <div className="flex py-5 justify-between">
          <div>
            ...
            <ul>
              <li className='pb-2'>Men</li>
              <li className='pb-2'>Women</li>
              <li className='pb-2'>Kids</li>
              <li className='pb-2'>Home & Living</li>
              <li className='pb-2'>Beauty</li>
              <li className='pb-2'>Gift Cards</li>
              <li className='pb-2'>Myntra Insider</li>
            </ul>
            <p className='py-5'>
              <b>USEFUL LINKS</b>
            </p>
            <ul>
              ...
              <li className='pb-2'>Site Map</li>
              <li className='pb-2'>Corporate nformation</li>
              <li className='pb-2'>Whitehat</li>
              <li className='pb-2'>Cleartrip</li>
            </ul>
          </div>
          <div>
            <p className='pb-5'>
          ...
          <div>Original Return within 14 days</div>
        </div>
        <div className="popularSearches py-10 border border-gray-50 border-1 border-y-gray-300">
          <p>
            <b>POPULAR SEARCHES</b>
          </p>
          <p className='pb-10 pt-5 leading-loose'>
            Makeup | Dresses For
            Girls | T-Shirts | Sandals | Headphones | Babydolls | Blazers For
            Men | Handbags | Ladies Watches | Bags | Sport Shoes | Reebok Shoes | Puma
            Shoes | Boxers | Wallets | Tops | Earrings | Fastrack
            Watches | Kurtis | Nike | Smart Watches | Titan Watches | Designer
            Blouse | Gowns | Rings | Cricket Shoes | Forever 21 | Eye Makeup | Photo Frames | 
            Punjabi Suits | Bikini | Myntra Fashion
            Show | Lipstick | Saree | Watches | Dresses | Lehenga |Nike
            Shoes | Goggles |Bras | Suit | Chinos | Shoes | Adidas Shoes | Woodland
            Shoes | Jewellery | Designers Sarees
          </p>
          <p className="inline mr-20 pt-10"> In case of any concern, Contact Us</p>
          <p className="inline ml-20 pt-10">
            2024 www.myntra.com. All rights reserved.
          </p>
          <p className="inline ml-40 pt-10">A Flipkart Company</p>
        </div>
        <div className="py-10 border border-gray-50 border-1 border-b-gray-300">
          <p className='pb-10'>
            <b>Registered Office Address</b>
          </p>
          <p>
            Buildings Alyssa,<br/>Begonia and Clover situated in Embassy Tech
            Village,<br/>Outer Ring Road,<br/>Devarabeesanahalli Village,
            <div className='flex flex-wrap'>
                <div className='basis-1/2'>Varthur Hobli,</div>
                <div className='basis-1/2 text-center pl-2'>CIN: U72300KA2007PTC041799</div>
                <div className='basis-1/2'>Bengaluru - 560103, India</div>
                <div className='basis-1/2 text-center'>Telephone: +91-80-61561999</div>
            </div>
          </p>
        </div>
        <div className="py-10">
          ...
          <p>
            ...
            <ol className="list-decimal list-outside pl-20">
              <li className='pt-5'>
                <p><b>Smart men’s clothing</b> - At Myntra you will find myriad
                options in smart formal shirts and trousers, cool T-shirts and
                jeans, or kurta and pyjama combinations for men. Wear your
                ...
                smart. Team them up with chinos, cuffed jeans or cropped
              ...
              <li className='pt-5'>
                <p><b>Trendy women’s clothing</b> - Online shopping for women at
              ...
              <li className='pt-5'>
                <p><b>Fashionable footwear</b> - While clothes maketh the man, the
                type of footwear you wear reflects your personality. We bring
                you an exhaustive lineup of options in casual shoes for men,
                ...
                running shoes for men and women. Choose shoes for individual
                games such as tennis, football, basketball, and the like. Or
                step into the casual style and comfort offered by sandals,
                sliders, and flip-flops. Explore our lineup of fashionable
                footwear for ladies, including pumps, heeled boots, wedge-heels,
                and pencil-heels. Or enjoy the best of comfort and style with
                embellished and metallic flats.</p>
              </li>
              <li className='pt-5'>
                <p><b>Stylish accessories</b> - Myntra is one of the best online
                shopping sites for classy accessories that perfectly complement
                your outfits. You can select smart analogue or digital watches
                and match them up with belts and ties. Pick up spacious bags,
                ...
                impressive options.</p>
              </li>
              <li className='pt-5'>
                <p><b>Fun and frolic</b> - Online shopping for kids at Myntra is a
                complete joy. Your little princess is going to love the wide
                ...
                football jerseys and much more from our online store. Check out
                our lineup of toys with which you can create memories to
                cherish.</p>
              </li>
              <li className='pt-5'>
                <p><b>Beauty begins here</b> - You can also refresh, rejuvenate and
                reveal beautiful skin with personal care, beauty and grooming
                products from Myntra. Our soaps, shower gels, skin care creams,
                lotions and other ayurvedic products are specially formulated to
                reduce the effect of aging and offer the ideal cleansing
                experience. Keep your scalp clean and your hair uber-stylish
                with shampoos and hair care products. Choose makeup to enhance
          ...
          <p className="pt-5">
            <b>AFFORDABLE FASHION AT YOUR FINGERTIPS</b>
          </p>
          <p>
          ...
          <p>
            ...
            <b>Insider</b>
            <ul className="list-disc list-outside pl-14">
              <li>
          ...
          <p className="pt-10 pb-3">
            <b>
              Myntra Studio- The Personalised Faishion Feed You Wouldn't Want To
              Miss Out On
            </b>
          </p>
          <p>
